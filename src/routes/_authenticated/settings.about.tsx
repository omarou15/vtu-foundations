    ...
    <div className="flex h-full flex-col">
      <header className="safe-top safe-x sticky top-0 z-10 border-b border-border bg-background md:hidden">
        <div className="flex h-14 items-center gap-2 px-3">
          ...
          <h1 className="font-heading text-base font-semibold tracking-tight">À propos</h1>
        </div>
      </header>
      <div className="flex-1">
        <ComingSoonPanel
          Icon={Info}
          title="À propos"
          description="Version, changelog, mentions légales, support."
          bullets={["Version de l'application", "Notes de version", "Contact support"]}
        />
      </div>
    </div>
  );
